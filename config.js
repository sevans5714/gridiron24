module.exports = {
  ...
  payouts: {
    ...
    teamCount: 24,
    currency: 'USD',
    notes: 'Prize pool is $2,400 from all 24 franchises at $100 buy-in. In Week 16, each conference’s semifinal losers play a third-place game — the winner gets their $100 buy-in back. Conference champions meet in Week 17’s GridIron Bowl for the top two prizes.',
    prizes: [
      { place: 1, label: 'GridIron 24 Champion', amount: 1200 },
      { place: 2, label: 'GridIron Bowl Runner-Up', amount: 500 },
      { place: 3, label: 'Detail Third Place Game Winner (buy-in refund)', amount: 100 },
      { place: 4, label: 'Overtime Third Place Game Winner (buy-in refund)', amount: 100 },
