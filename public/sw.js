...
const SHELL = [
  ...
  '/assets/pwa/icon-192.png?v=49',
  '/assets/pwa/icon-512.png?v=49',
  '/assets/pwa/icon-maskable-512.png?v=49',
  '/assets/pwa/icon-192-transparent.png?v=49',
  '/assets/pwa/apple-touch-icon.png?v=49',
