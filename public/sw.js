...
const SHELL = [
  ...
  '/assets/pwa/icon-192.png?v=53',
  '/assets/pwa/icon-512.png?v=53',
  '/assets/pwa/icon-maskable-512.png?v=53',
  '/assets/pwa/icon-192-transparent.png?v=53',
  '/assets/pwa/apple-touch-icon.png?v=53',
